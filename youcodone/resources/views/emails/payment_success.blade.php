    ...
    <div class="container">
        ...
        <div class="header">
            <div class="logo">
                ...
                <div class="logo-text">
                    <div class="brand">youcod'one</div>
                    <div class="tagline">L'art de la table, à portée de clic.</div>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="details-card">
                <div class="detail-row">
                    ...
                    <span
                        class="detail-value restaurant-name">{{ $paiement->reservation->restaurant->nom_restaurant }}</span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">Date</span>
                    <span
                        class="detail-value">{{ \Carbon\Carbon::parse($paiement->reservation->date_reservation)->translatedFormat('d F Y') }}</span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"
                        style="max-width: 200px;">{{ $paiement->reservation->restaurant->adresse_restaurant }}</span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span
                        class="detail-value">{{ \Carbon\Carbon::parse($paiement->date_paiement)->translatedFormat('d F Y à H:i') }}</span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"
                        style="color: #22c55e; text-transform: uppercase; font-size: 12px; letter-spacing: 1px;">{{ $paiement->statut }}</span>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 30px; border-top: 1px solid #e5e5e5;">
                <p style="color: #999999; font-size: 12px; line-height: 1.6;">
                    ...
                    <a href="mailto:reservations@youcodone.com"
                        style="color: #FF6B35; text-decoration: none;">reservations@youcodone.com</a>
                </p>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="footer-logo">
                ...
                <span class="brand">youcod'one</span>
            </div>
