<x-app-layout>
    ...
    <div class="relative bg-[#0a0a0a] py-32 border-b border-[#FF6B35]/10 overflow-hidden">
        <!-- Background Effects -->
        <div
            class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#FF6B35]/5 via-transparent to-transparent opacity-50">
        </div>
        <div class="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#FF6B35]/30 to-transparent">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 text-center relative z-10">
            ...
            <h1
                class="text-5xl md:text-7xl lg:text-8xl font-serif font-bold italic text-white mb-8 leading-none animate-fade-in delay-100">
                Trouvez votre <br>
            ...
            <form action="{{ route('home') }}" method="POST" class="max-w-2xl mx-auto animate-fade-in delay-300">
                ...
                <div class="relative group">
                    <div
                        class="absolute inset-0 bg-[#FF6B35]/20 rounded-full blur-xl opacity-0 group-focus-within:opacity-100 transition-opacity duration-500">
                    </div>
                    ...
                    <svg class="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 group-focus-within:text-[#FF6B35] transition-colors"
    ...
    <div class="max-w-7xl mx-auto px-6 py-24">
        @if ($restaurants->isEmpty())
            <div
                class="flex flex-col items-center justify-center py-32 border border-dashed border-white/10 rounded-[3rem] bg-gradient-to-b from-white/[0.02] to-transparent relative overflow-hidden">
                <div
                    class="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#FF6B35]/5 via-transparent to-transparent opacity-30">
                </div>

                <div
                    class="w-24 h-24 bg-[#FF6B35]/5 border border-[#FF6B35]/20 rounded-full flex items-center justify-center mb-8">
        ...
        @else
            <div class="flex items-end justify-between mb-12">
                <div>
                    <span class="text-[#FF6B35] text-[10px] font-bold uppercase tracking-[0.3em] mb-2 block">Nos
                        Sélections</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($restaurants as $restaurant)
                    <div
                        class="group relative bg-[#111] border border-white/5 rounded-[2rem] overflow-hidden hover:border-[#FF6B35]/30 transition-all duration-700 shadow-2xl hover:shadow-[#FF6B35]/5 hover:-translate-y-2">
                        ...
                        <div class="relative h-80 overflow-hidden">
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-[#111] via-black/40 to-transparent opacity-90">
                            </div>
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-3 mb-4">
                                <span
                                    class="px-3 py-1 bg-[#FF6B35]/10 border border-[#FF6B35]/20 rounded-full text-[10px] font-bold text-[#FF6B35] uppercase tracking-wider">
                                    {{ $restaurant->typeCuisine->nom_type_cuisine }}
                                </span>
                                @if ($restaurant->prix_reservation)
                                    <span
                                        class="text-gray-500 text-xs">{{ number_format($restaurant->prix_reservation, 0) }}
                                        DH</span>
                                @endif
                            </div>

                            <h3
                                class="text-2xl font-serif font-bold italic text-white mb-4 group-hover:text-[#FF6B35] transition-colors duration-300 leading-tight">
                            ...
                            <div class="flex items-center justify-between">
                                <a href="{{ route('client.restaurant.show', $restaurant) }}"
                                    ...
                                    Réserver
                                    <span
                                        class="w-8 h-[1px] bg-[#FF6B35] group-hover/link:w-12 transition-all duration-300"></span>
                                </a>
                        ...
                        <div
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000">
                            </div>
                        </div>
                    </div>
                @endforeach
