    ...
    <div class="bg-[#050505] min-h-screen text-gray-200 font-serif pb-32">
        ...
        <section class="relative h-[40vh] w-full overflow-hidden bg-black flex items-center border-b border-white/10">
            ...
            <div class="absolute inset-0 z-20 flex flex-col items-center justify-center text-center">
                ...
                <p class="text-[#FF5F00] text-[9px] font-black tracking-[1em] uppercase mt-4">Chapitre III — Transaction
                    Sécurisée</p>
            </div>
        </section>
        ...
        <main class="max-w-4xl mx-auto px-6 mt-[-10vh] relative z-30">
            <div class="bg-white/[0.02] border border-white/10 p-8 md:p-16 rounded-sm backdrop-blur-xl shadow-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
                    ...
                    <div class="space-y-8">
                        <div>
                            <h2
                                class="text-[#FF5F00] text-[10px] font-black tracking-[0.5em] uppercase mb-6 flex items-center gap-4">
                        ...
                        <form action="{{ route('paiement.checkout') }}" method="POST" class="space-y-10">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center gap-4 p-4 border border-white/10 bg-white/5 rounded-sm">
                                    <div
                                        class="w-12 h-8 bg-gray-800 rounded flex items-center justify-center border border-white/10">
                                        <span
                                            class="text-[8px] tracking-widest text-gray-400 uppercase font-black">Visa</span>
                                    </div>
                                    <div
                                        class="w-12 h-8 bg-gray-800 rounded flex items-center justify-center border border-white/10">
                                        <span
                                            class="text-[8px] tracking-widest text-gray-400 uppercase font-black">MC</span>
                                    </div>
                                    <span
                                        class="text-[10px] text-gray-400 uppercase tracking-widest ml-auto italic">Cartes
                                        acceptées</span>
                                </div>
                            </div>
            ...
            <div class="mt-12 text-center">
                <a href="{{ url()->previous() }}"
                    class="text-[10px] uppercase tracking-[3px] text-gray-600 hover:text-[#FF5F00] transition-colors">
                    ← Retour au registre
                </a>
            </div>
        </main>
